...
exports.CreatePersonsDto = void 0;
var class_validator_1 = require("class-validator");
var CreatePersonsDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            ...
            return CreatePersonsDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _firstName_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)({ message: 'Nombre es requerido' }), (0, class_validator_1.Length)(2, 50)];
            _lastName_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)({ message: 'Apellido es requerido' }), (0, class_validator_1.Length)(2, 50)];
            _phoneNumber_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.Matches)(/^\d{8}$/, {
                    message: 'Número de teléfono debe tener exactamente 8 dígitos o es invalido',
                })];
            _email_decorators = [(0, class_validator_1.IsEmail)({}, { message: 'Forma de correo inválido' })];
...
exports.CreatePersonsDto = CreatePersonsDto;
